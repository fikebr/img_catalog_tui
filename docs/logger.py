...
#   import logging
#
#   # initialize once early (e.g., in main.py)
#   ProjectLogger(keep=10, level=logging.DEBUG).init()
#
...
# ---------------------------------------------------------------------------
#
# • Creates logs in ./log/YYYY-MM-DD.log
# • Rotates automatically at midnight (new file per day)
# • Keeps only the latest N logs (configurable with `keep`)
# • Logs appear both in console and in file
# • Format:
#       HHMMSS - ERR|WRN|INF|DBG - file(10) - function(12):linenum - message
#
# Example output:
#       142317 - INF - app.py     - run_server :42 - Server started
#       142318 - WRN - cache.py   - get_user   :88 - Missing key in cache
#       142319 - ERR - db.py      - connect    :15 - Connection timeout
#
# ---------------------------------------------------------------------------
# Optional improvements:
# • Colored console output (using colorama or rich)
